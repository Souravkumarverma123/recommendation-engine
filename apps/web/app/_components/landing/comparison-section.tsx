  ...
  return (
    <section className="border-t border-hairline bg-canvas-soft px-6 py-20">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mt-10 overflow-hidden rounded-lg border border-hairline bg-surface-card">
          <div className="grid grid-cols-[1fr_84px_84px] items-center gap-2 border-b border-hairline-soft px-6 py-4 sm:grid-cols-[1fr_140px_140px] sm:gap-4">
            <span />
          ...
          {ROWS.map((row) => (
            <div
              key={row.label}
              className="grid grid-cols-[1fr_84px_84px] items-center gap-2 border-b border-hairline-soft px-6 py-4 last:border-b-0 sm:grid-cols-[1fr_140px_140px] sm:gap-4"
            >
